...
{
    /// <summary>
    /// Lifted from CQRS Journey
    /// </summary>
    public static class AwaitTimer
    {
        ...
        public static Task<T> WaitUntil<T>(Func<T> getResult, Func<T, bool> isResultValid, TimeSpan pollInterval, TimeSpan timeout)
        {
            Timer timer = null;
            ...
            completionSource = new TaskCompletionSource<T>(timer);
